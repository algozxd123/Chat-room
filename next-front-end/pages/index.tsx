  ...
  return (
    ...
    <div className="h-screen flex flex-col justify-center items-center">
      <div className="px-4 py-2 w-11/12 lg:w-1/2 h-96 max-h-96 border-solid border-4 rounded-xl border-primary bg-white">
        ...
        <ChatMessage username={"glubdub"} date={"21-09-2001 11:89"} text={"Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus consequuntur dolorum nam, deleniti cumque et aut sit architecto voluptates libero officiis natus, earum iure quam est nulla, similique nostrum ad!"} />
        <ChatMessage username={"glubdub"} date={"21-09-2001 11:89"} text={"Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus consequuntur dolorum nam, deleniti cumque et aut sit architecto voluptates libero officiis natus, earum iure quam est nulla, similique nostrum ad!"} />
        <ChatMessage username={"glubdub"} date={"21-09-2001 11:89"} text={"Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus consequuntur dolorum nam, deleniti cumque et aut sit architecto voluptates libero officiis natus, earum iure quam est nulla, similique nostrum ad!"} />
        <ChatMessage username={"glubdub"} date={"21-09-2001 11:89"} text={"Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus consequuntur dolorum nam, deleniti cumque et aut sit architecto voluptates libero officiis natus, earum iure quam est nulla, similique nostrum ad!"} />
        <ChatMessage username={"glubdub"} date={"21-09-2001 11:89"} text={"Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus consequuntur dolorum nam, deleniti cumque et aut sit architecto voluptates libero officiis natus, earum iure quam est nulla, similique nostrum ad!"} />
